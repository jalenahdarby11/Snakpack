...
<body>
    ...
    <h1 class="heading main-heading article">Food is a universal language, and every culture has its own unique snacks that reflect their traditions and flavors. Whether you're traveling the world or exploring your own city, here are 10 snacks you absolutely need to try.</h1>

    <h2 class="heading subheading article">1. <strong>Pocky (Japan)</strong></h2>
    <img src="https://example.com/images/pocky.jpg" alt="Pocky snack from Japan">
    ...
    <img src="https://example.com/images/churros.jpg" alt="Churros from Spain with chocolate dip">
    ...
    <img src="https://example.com/images/knafeh.jpg" alt="Middle Eastern Knafeh dessert">
    ...
    <img src="https://example.com/images/samosas.jpg" alt="Indian samosas filled with potatoes and peas">
    ...
    <img src="https://example.com/images/biltong.jpg" alt="South African biltong dried meat">
