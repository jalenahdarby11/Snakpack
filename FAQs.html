    ...
    <main class="main-content">
      ...
      <section class="faq-list">
        <article class="faq-item">
          ...
          <img src="https://cdn.builder.io/api/v1/image/assets/3a8ac60b581045f7adb5757904dc023c/baafaabb93f56825dd22d9c6f558b44171607dc0?placeholderIfAbsent=true" alt="Expand" class="expand-icon" />
        </article>
        ...
        <article class="faq-item">
          <h2 class="faq-question">Can I customize my box?</h2>
          <img src="https://cdn.builder.io/api/v1/image/assets/3a8ac60b581045f7adb5757904dc023c/baafaabb93f56825dd22d9c6f558b44171607dc0?placeholderIfAbsent=true" alt="Expand" class="expand-icon" />
        </article>
    ...
    <footer class="footer">
      <div class="footer-content">
        ...
        <nav class="footer-nav">
          ...
          <a href="GetStarted.html" class="footer-link">Get Started</a>
        </nav>
